...
const (
	...
	flagUnknownShorthandNFlagMessage
)
...
func (e *NotExistError) Error() string {
	...
	case flagUnknownShorthandNFlagMessage:
		return fmt.Sprintf("unknown shorthand flag: -%s", e.name) // custom carapace-sh/carapace-pflag message for non-posix shorthand (chain disabled)
	}
